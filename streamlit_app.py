...
st.write("Recently, we came across an article published by \
         ...
         binary logistic regression. The results of their research showed significant discrepancies across 48 different metropolitan areas.<br>\
         This research was conducted over 5 years ago using 2015 and 2016 mortgage data provided by Home Mortgage Disclosure Act (HMDA). \
